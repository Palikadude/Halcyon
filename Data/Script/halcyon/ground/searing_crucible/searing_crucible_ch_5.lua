...
-- GROUND:AnimateInDirection(zigzagoon, "Walk", zigzagoon.Direction, Direction.Down, 8, 1, 1)
	...
	UI:WaitShowDialogue("It makes my blood boil with rage![pause=0] That tears it!")
	GAME:WaitFrames(10)
...
function searing_crucible_ch_5.DefeatedBoss()
	...
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("What are you talking about?[pause=0] We don't want to hurt you!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(magcargo)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("...[pause=30]Mercy?[pause=0] You give us mercy in our moment of vulnerability?")
	...
	UI:SetSpeaker(partner)
	GROUND:CharSetEmote(partner, "sweating", 1)
	UI:WaitShowDialogue("It's alright,[pause=10] we're all squared away now right?")
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Worried")
	...
	UI:WaitShowDialogue("Between the horrible fluctuations in the lava flow and all the other outlanders passing through here today...")
	UI:WaitShowDialogue("...I thought this was a return to those times.")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(magcargo)
	UI:WaitShowDialogue("Historically,[pause=10] the lava flowing through this tunnel has been stable and steady.")
	UI:WaitShowDialogue("All sorts of Pokémon,[pause=10] Fire-type or not,[pause=10] have been able to call this place home.")
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("But recently,[pause=10] the lava flow has become irregular.")
	UI:WaitShowDialogue("Unpredictably,[pause=10] sections of the tunnel overflow with lava,[pause=10] driving out the less heat-resistant Pokémon.")
	UI:WaitShowDialogue("Meanwhile,[pause=10] other sections dry up,[pause=10] leaving those such as ourselves feeling cold and numb.")
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue("The inconsistency has been very stressful for every Pokémon living in this place.")
	UI:WaitShowDialogue("When the lava flow erupted as you outlanders passed through...[pause=0] I figured you were the culprits.")
	UI:WaitShowDialogue("But given your mercy towards our clan,[pause=10] it is clear you are not to blame for this.[pause=0] It was merely a coincidence.")
	GAME:WaitFrames(20)
	
	UI:SetSpeaker(partner)
	UI:WaitShowDialogue("So that's why you attacked us...")
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("But how could we have possibly caused the lava flow to change?[pause=0] We don't have that sort of power!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("But please understand that our behavior was guided by agitation and mistrust rather than logic.")
	...
	UI:WaitShowDialogue("Phew![pause=0] What a tense situation![pause=0] Thank goodness it's over with!")
	GAME:WaitFrames(20)
	...
	UI:WaitShowDialogue("Same![pause=0] We would have been in trouble if you guys weren't here,[pause=10] ruff!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("I don't know...[pause=0] What could even cause something like that?")
	UI:WaitShowDialogue("Whatever it is,[pause=10] it doesn't seem natural...[pause=0] Could a Pokémon be behind it?")
	...
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue("Wait,[pause=10] forget about the lava![pause=0] How long have we been in this tunnel for?")
	GAME:WaitFrames(10)
	...
	UI:SetSpeaker(zigzagoon)
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue("Oh no![pause=0] We got held up by " .. magcargo:GetDisplayName() .. " and his clan![pause=0] It's got to be late by now!")
	GAME:WaitFrames(20)
	
	UI:SetSpeaker(growlithe)
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue("Ruff![pause=0] We've got to hurry to the next base camp before nightfall![pause=0] Come on,[pause=10] ruff!")
