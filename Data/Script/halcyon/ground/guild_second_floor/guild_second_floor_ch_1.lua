...
function guild_second_floor_ch_1.Zigzagoon_Action(chara, activator)
	...
	if not SV.Chapter1.MetZigzagoon then
		...
		UI:SetSpeakerEmotion("Inspired")
		UI:WaitShowDialogue("This is great![pause=0] I finally have juniors that I can teach!")
		UI:WaitShowDialogue("I'll have to show you both my almanac,[pause=10] I bet you could learn a lot from it!")
		GAME:WaitFrames(20)
		...
		UI:WaitShowDialogue("Yeah![pause=0] Everything I learn about adventuring I write down in my almanac![script=0]", {function() return HopThenIdle() end})
		...
		UI:WaitShowDialogue("I bet me and " .. hero:GetDisplayName() .. " could learn a lot of useful stuff from something like that!")
		GAME:WaitFrames(20)
