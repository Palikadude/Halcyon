...
function ledian_dojo_ch_2.PreTrainingCutscene()
	...
	coro2 = TASK:BranchCoroutine(function() GAME:WaitFrames(30)
											GROUND:MoveToPosition(ledian, 196, 208, false, 1)
	...
	coro1 = TASK:BranchCoroutine(function() GROUND:AnimateToPosition(ledian, "Walk", Direction.Up, 176, 208, 1, 1)
											...
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Right, 160, 184, 1, 1) 
											GROUND:CharSetAnim(ledian, "Idle", true) end)
	...
	coro1 = TASK:BranchCoroutine(function() GROUND:AnimateToPosition(ledian, "Walk", Direction.Right, 160, 184, 1, 1)
											...
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Left, 232, 184, 1, 1) 
											GROUND:CharSetAnim(ledian, "Idle", true) end)
	...
	if result == 1 then
		...
		local coro5 = TASK:BranchCoroutine(function() GAME:WaitFrames(136) GAME:FadeOut(false, 20) end)
