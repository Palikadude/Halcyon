...
function ledian_dojo_ch_2.PreTrainingCutscene()
	...
	local lesson = _DATA.DataIndices[RogueEssence.Data.DataManager.DataType.Zone].Entries[51]
	local maze = _DATA.DataIndices[RogueEssence.Data.DataManager.DataType.Zone].Entries[52]
	GAME:FadeIn(20)
	...
	coro1 = TASK:BranchCoroutine(function() GROUND:AnimateToPosition(ledian, "Walk", Direction.Up, 176, 208, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.UpRight, 160, 192, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Right, 160, 184, 1, 1) end)
	...
	coro1 = TASK:BranchCoroutine(function() GROUND:AnimateToPosition(ledian, "Walk", Direction.Right, 160, 184, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.UpRight, 176, 208, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Up, 216, 208, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.UpLeft, 232, 192, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Left, 232, 184, 1, 1) end)
	...
	coro1 = TASK:BranchCoroutine(function() GROUND:AnimateToPosition(ledian, "Walk", Direction.Left, 232, 176, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.DownLeft, 216, 160, 1, 1)
											GROUND:AnimateToPosition(ledian, "Walk", Direction.Down, 196, 160, 1, 1)
	...
	if result == 1 then
		...
		local coro5 = TASK:BranchCoroutine(function() GAME:WaitFrames(136) SOUND:FadeOutBGM() GAME:FadeOut(false, 20) end)
	...
	if result == 2 then 
		...
		coro3 = TASK:BranchCoroutine(function() GAME:WaitFrames(20)
												GROUND:MoveInDirection(ledian, Direction.Down, 196, false, 1) end)
		local coro4 = TASK:BranchCoroutine(function() GAME:WaitFrames(120) SOUND:FadeOutBGM() GAME:FadeOut(false, 20) end)
