...
function guild_guildmasters_room_ch_1.MeetGuildmaster()
	...
	UI:WaitShowDialogue("Two prospective teams in one day...[pause=0] I don't think that's ever happened before.")
	...
	UI:WaitShowDialogue("M-m-my n-name is...[pause=0] I-Is...")
	GAME:WaitFrames(20)
...
--	UI:WaitShowDialogue("But I'm getting offtopic.[pause=0] What's important right now is your apprenticeship!")
	...
	elseif result == 2 then 
		...
		GeneralFunctions.HeroDialogue(hero, "(I don't know " .. GeneralFunctions.GetPronoun(partner, "them") .. " that well yet but they're still my only friend in this world...)", "Worried")
		GAME:WaitFrames(20)
	...
	UI:WaitShowDialogue("Not only are they trackers in case something should ever happen to you...")
	...
	UI:WaitShowDialogue("If you do enough good adventuring work it'll be upgraded to carry more items!")
