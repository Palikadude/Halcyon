...
--	UI:WaitShowDialogue("But I'm getting offtopic.[pause=0] What's important right now is your apprenticeship!")
	...
	GROUND:CharTurnToCharAnimated(tropius, noctowl, 4)
	GROUND:CharTurnToCharAnimated(noctowl, tropius, 4)
	UI:WaitShowDialogue("Do you have any thoughts,[pause=10] " .. noctowl:GetDisplayName() .. "?")
	GAME:WaitFrames(20)
	UI:SetSpeaker(noctowl)
	UI:WaitShowDialogue("Of course I have thoughts,[pause=10] Guildmaster.")
	GAME:WaitFrames(20)
	UI:SetSpeaker(tropius)
	UI:WaitShowDialogue("...I meant do you have any thoughts on our prospective recruits here.")
	GAME:WaitFrames(20)
	UI:SetSpeaker(noctowl)
	UI:WaitShowDialogue("Oh.[pause=0] I have no quarrels,[pause=10] Guildmaster.")
	GAME:WaitFrames(20)
	UI:SetSpeaker(tropius)
	UI:WaitShowDialogue("That's what I figured!")
	GROUND:CharAnimateTurnTo(tropius, Direction.Down, 4)
	...
	UI:WaitShowDialogue("The map will help you locate discovered areas.[pause=0] It should keep you from getting lost.")
	UI:WaitShowDialogue("The adventurers badges are incredible tools!")
	...
	UI:WaitShowDialogue("The item bag is self-explanatory.")
	...
	UI:WaitShowDialogue("They don't do anything normally...")
	...
	coro3 = TASK:BranchCoroutine(function() GAME:WaitFrames(40) GROUND:CharSetEmote(tropius, 4, 0) end)
	GAME:WaitFrames(120)
