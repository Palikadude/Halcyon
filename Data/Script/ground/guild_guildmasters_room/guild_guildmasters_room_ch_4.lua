...
function guild_guildmasters_room_ch_4.PresentApricornCutscene()
	...
	UI:WaitShowDialogue("Have you finished your exploration of " .. zone:GetColoredName() .. "?[pause=0] Have you managed to discover anything?")
	GAME:WaitFrames(20)
	...
	coro1 = TASK:BranchCoroutine(function() UI:WaitShowDialogue("That's wonderful![pause=0] It joys me to hear that you used to teamwork to get the Apricorn!") 
											UI:WaitShowDialogue("It sounds like it was your adventure was a complete success!")
								 end)
	coro2 = TASK:BranchCoroutine(function() GAME:WaitFrames(6) 
	...
	UI:WaitShowDialogue("You were the one who told us about " .. zone:GetColoredName() .. " after all.")
	GAME:WaitFrames(10)
	...
	UI:SetSpeaker(tropius)
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue("Of course![pause=0] It's your treasure,[pause=10] after all!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(tropius)
	UI:WaitShowDialogue("Why don't you two head on to the dining room now?[pause=0] Dinner should be ready any moment now.")
	GAME:WaitFrames(20)
	...
	coro5 = TASK:BranchCoroutine(function() GAME:WaitFrames(60) SOUND:FadeOutBGM(40) end)
	...
	UI:WaitShowDialogue("Of course,[pause=10] " .. noctowl:GetDisplayName() .. ".[pause=0] The way Team " .. GAME:GetTeamName() .. " performed on this mission was perfect!")
