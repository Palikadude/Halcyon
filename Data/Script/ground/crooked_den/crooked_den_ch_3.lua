...
function crooked_den_ch_3.FirstPreBossScene()
	...
	GROUND:CharSetEmote(sandile, "sweating", 1)
	UI:WaitShowDialogue("U-um,[pause=10] well,[pause=10] ever since I was young I've idolized those who were beautiful and majestic...") 
	...
	UI:WaitShowDialogue("I thought that maybe with a scarf like that,[pause=10] I could finally look how I've always wanted to...[pause=0] So I asked him how much they were.")
	
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue("The price he told me was staggering...[pause=0] I didn't have that kind of money.")
	UI:WaitShowDialogue("But it was so beautiful,[pause=10] I just had to have it![pause=0] I couldn't help but steal it...")
	...
	UI:SetSpeakerEmotion("Stunned")
	UI:WaitShowDialogue(".........")
	UI:WaitShowDialogue("Um...[pause=0] Because,[pause=10] deep down,[pause=10] I still wanted to keep the scarf.")
	UI:WaitShowDialogue("It was just so beautiful![pause=0] And it still makes me feel so beautiful too...")
	...
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue("Well,[pause=10] I'm glad we were able to resolve this without a fight at least.[pause=0] I hope the law doesn't go hard on you.")
