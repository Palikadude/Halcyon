...
function metano_water_home_ch_2.Quagsire_Action(chara, activator)
	GeneralFunctions.StartConversation(CharacterEssentials.GetCharacterName("Wooper_Girl") .. ' and ' .. CharacterEssentials.GetCharacterName('Wooper_Boy') .. " are still out there trying to figure out their plans for the day.", "Worried")
