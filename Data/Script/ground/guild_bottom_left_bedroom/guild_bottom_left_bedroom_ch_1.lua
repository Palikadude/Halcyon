...
function guild_bottom_left_bedroom_ch_1.Girafarig_Action(chara, activator)
	if not SV.Chapter1.MetBreloomGirafarig then
		...
		UI:WaitShowDialogue("We're the most senior appetizers here,[pause=10] so come to us if you need help!")
...
function guild_bottom_left_bedroom_ch_1.Breloom_Action(chara, activator)
	...
	--	SOUND:PlayBGM("Wigglytuff's Guild Remix.ogg", true)
		...
		UI:WaitShowDialogue(tail:GetDisplayName() .. " won't stop making fun of me![pause=0] I've asked him to stop so many times and he won't!")
		GAME:WaitFrames(20)
		...
		UI:SetSpeaker(STRINGS:Format("\\uE040"), true, breloom.CurrentForm.Species, breloom.CurrentForm.Form, breloom.CurrentForm.Skin, breloom.CurrentForm.Gender)
		UI:SetSpeakerEmotion("Normal")
		UI:WaitShowDialogue("You and " .. tail:GetDisplayName() .. " sure have been butting heads a lot recently.")
		GAME:WaitFrames(20)
		...
		UI:SetSpeaker(STRINGS:Format("\\uE040"), true, girafarig.CurrentForm.Species, girafarig.CurrentForm.Form, girafarig.CurrentForm.Skin, girafarig.CurrentForm.Gender)
		UI:SetSpeakerEmotion("Normal")
		UI:WaitShowDialogue("C'mon,[pause=10] don't freak out the rooftops.[pause=0] They haven't found out yet that you're not funny.")
		GAME:WaitFrames(20)
		...
		UI:WaitShowDialogue("(Anyway,[pause=10] he thinks his tail is a person.[pause=0] He gave it a name and everything.)")
		...
		GROUND:CharTurnToChar(partner, breloom)
		GROUND:CharTurnToChar(hero, breloom)	
		UI:WaitShowDialogue("By the way,[pause=10] if you gatecrashers ever need help with anything,[pause=10] especially exploring,[pause=10] let me or " .. girafarig:GetDisplayName() .. " know.")
		...
		UI:SetSpeaker(girafarig)
		UI:SetSpeakerEmotion("Happy")
		UI:WaitShowDialogue("Yeah![pause=0] We're the most senior appetizers here,[pause=10] so come to us if you need help!")
		UI:WaitShowDialogue(tail:GetDisplayName() .. " and I would be glad to tutor you anytime!")
		GAME:WaitFrames(20)
		...
		AI:SetCharacterAI(partner, "ai.ground_partner", CH('PLAYER'), chara.Position)
