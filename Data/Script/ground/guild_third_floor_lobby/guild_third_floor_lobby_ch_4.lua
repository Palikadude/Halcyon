...
function guild_third_floor_lobby_ch_4.ExpeditionAnnouncementAddress()
	...
	coro4 = TASK:BranchCoroutine(function() GAME:WaitFrames(6) GROUND:CharTurnToCharAnimated(mareep, noctowl, 4) end)
	coro5 = TASK:BranchCoroutine(function() GROUND:CharTurnToCharAnimated(audino, noctowl, 4) end)
	coro6 = TASK:BranchCoroutine(function() GAME:WaitFrames(4) GROUND:CharTurnToCharAnimated(growlithe, noctowl, 4) end)
	coro7 = TASK:BranchCoroutine(function() GROUND:CharTurnToCharAnimated(zigzagoon, noctowl, 4) end)
	...
	UI:WaitShowDialogue("Hahaha![pause=0] I can see you're excited!")
	GAME:WaitFrames(20)
