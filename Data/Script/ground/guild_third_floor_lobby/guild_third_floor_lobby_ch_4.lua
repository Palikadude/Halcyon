...
function guild_third_floor_lobby_ch_4.ExpeditionAnnouncementAddress()
	...
	UI:WaitShowDialogue("Howdy Pokémon![pause=0] I have a special announcement to make before we get to the day's adventures!")
	...
	coro2 = TASK:BranchCoroutine(function() GROUND:CharAnimateTurnTo(noctowl, Direction.Right, 4) end)
	coro3 = TASK:BranchCoroutine(function() GAME:WaitFrames(4) GROUND:CharAnimateTurnTo(hero, Direction.UpRight, 4) end)
	...
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("They won't be back for some time,[pause=10] so you all have time to do anything you may need to before we embark!")
	...
	UI:WaitShowDialogue("However,[pause=10] as it turns out,[pause=10] this forest is actually a mystery dungeon too![pause=0] Pokémon are calling it " .. zone:GetColoredName() ..".")
	...
	UI:WaitShowDialogue("Yes yes yes![pause=0] Oh,[pause=10] this is so exciting![pause=0] We won't let you down,[pause=10] Guildmaster!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(tropius)
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue("I know you will![pause=0] Good luck,[pause=10] and stay safe![pause=0] I know you two will do great!")
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("I'll be heading to my office now.[pause=0] Come see me if you need anything!")
	GAME:WaitFrames(20)
	...
	UI:SetSpeaker(partner)
	UI:SetSpeakerEmotion("Inspired")
	UI:WaitShowDialogue("I still can't believe it,[pause=10] " .. hero:GetDisplayName() .. "![pause=0] The expedition![pause=0] Us going on a real adventure!")
