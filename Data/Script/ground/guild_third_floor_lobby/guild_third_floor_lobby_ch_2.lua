...
function guild_third_floor_lobby_ch_2.FirstMorningMeeting()
	...
	local coro1 = TASK:BranchCoroutine(function() GROUND:MoveToPosition(partner, 408, 336, true, 3)
	...
	local coro2 = TASK:BranchCoroutine(function() GROUND:MoveToPosition(hero, 408, 336, true, 3)
	...
	GAME:WaitFrames(20)
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("On to business...[pause=0] As it's your first day,[pause=10] allow me to explain to you how your guild training will work.")
	...
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue("Oh,[pause=10] and we usually have dinner around sunset,[pause=10] so make it back by then if you want to have some of " .. snubbull:GetDisplayName() .. "'s cooking!")
	UI:SetSpeakerEmotion("Normal")
