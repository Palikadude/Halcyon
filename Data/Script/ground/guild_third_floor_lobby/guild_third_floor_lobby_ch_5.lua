...
function guild_third_floor_lobby_ch_5.ExpeditionAddress()
	...
	UI:WaitShowDialogue(noctowl:GetDisplayName() .. " and I will need to speak with you to figure out details.")
	...
	UI:WaitShowDialogue("We're excited to go on an adventure that doesn't involve catching ba-a-a-addies,[pause=10] aren't we " .. cranidos:GetDisplayName() .. "?")
	GAME:WaitFrames(20)
	...
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue("I'm r-really looking forward to exploring with you,[pause=10] " .. GeneralFunctions.NameStutter(mareep) .. "!")
	GAME:WaitFrames(20)
	...
	UI:WaitShowDialogue("An adventure to discover the secret of an ancient ruin with all my friends...")
	UI:WaitShowDialogue("I've dreamed about that for so long,[pause=10] and now it's finally happening!")
	...
	GeneralFunctions.HeroDialogue(hero, "(This expedition is shaping up to be something special![pause=0] I'm feeling really pumped up about it!)", "Happy")
	GeneralFunctions.HeroDialogue(hero, "(I don't know if it's that strange tension or just plain excitement,[pause=10] but I don't care!)", "Inspired")
	GeneralFunctions.HeroDialogue(hero, "(I'm looking forward to going on this expedition with " ..  partner:GetDisplayName() .. "!)", "Inspired")
	GAME:WaitFrames(20)
	...
	GROUND:CharSetAnim(growlithe, "Idle", true)
	coro1 = TASK:BranchCoroutine(function() UI:WaitShowTimedDialogue("Ruff![pause=30] I'm gonna head into town right now to get ready,[pause=10] ruff![pause=30] I can't wait!", 40) end)
	...
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("Well,[pause=10] I'd better go make my preparations as well.[pause=0] I'll see you all in a bit!")
	
	
	UI:SetSpeaker(mareep)
	coro1 = TASK:BranchCoroutine(function() GAME:WaitFrames(42)
											UI:WaitShowDialogue("Well,[pause=10] we should go get ready too![pause=0] Ooh,[pause=10] this expedition's gonna be a bla-a-a-ast!") end)
	...
	coro3 = TASK:BranchCoroutine(function() GAME:WaitFrames(34)
											GROUND:CharAnimateTurnTo(mareep, Direction.Down)
											end)
	coro4 = TASK:BranchCoroutine(function() GAME:WaitFrames(44) 
											GROUND:CharAnimateTurnTo(cranidos, Direction.Up, 4)
											end)
	coro5 = TASK:BranchCoroutine(function() GAME:WaitFrames(38) 
											GROUND:CharAnimateTurnTo(audino, Direction.Up, 4)
											end)
	coro6 = TASK:BranchCoroutine(function() GAME:WaitFrames(42) 
											GROUND:CharAnimateTurnTo(snubbull, Direction.Down, 4)
											end)	
	coro7 = TASK:BranchCoroutine(function() GAME:WaitFrames(46) 
											GROUND:CharAnimateTurnTo(partner, Direction.DownRight, 4)
											end)
	...
	coro1 = TASK:BranchCoroutine(function() GAME:WaitFrames(40)
											UI:WaitShowDialogue("We'd best prepare too.[pause=0] I know I need to stock all sorts of ingredients for such a long trip. " .. STRINGS:Format("\\u266A")) end)
	...
	coro4 = TASK:BranchCoroutine(function() GAME:WaitFrames(40)
	...
	UI:SetSpeakerEmotion("Inspired")
	UI:WaitShowDialogue("We should go and get ready ourselves,[pause=10] " .. hero:GetDisplayName() .. "!")
	UI:WaitShowDialogue("C'mon![pause=0] Let's head into town and get ready for the expedition!")
