...
function relic_forest_ch_1.Intro_Cutscene()
	...
	GAME:WaitFrames(180)
  	...
  	UI:WaitShowVoiceOver("...Eyes close and dream of fantastical realms...", -1)  
	UI:WaitShowVoiceOver("...Eyes open and meet with candid reality...", -1)  
	UI:WaitShowVoiceOver("...Worlds apart, yet intertwined.", -1)  
	UI:WaitShowVoiceOver(".........", -1)  
	UI:WaitShowVoiceOver("But where does that leave you?", -1) 
...
--[color=#00FFFF]Erleuchtet[color]
	...
	UI:WaitShowDialogue("(" .. GeneralFunctions.GetPronoun(hero, 'they', true) .. " even pinched " .. GeneralFunctions.GetPronoun(hero, 'themself', true) .. " like this was some sort of dream...)")
	UI:WaitShowDialogue("(And there's no reason for someone to lie about this sort of thing,[pause=10] right?)")
	GAME:WaitFrames(40)
	...
	UI:WaitShowDialogue("I think that maybe you're not lying after all,[pause=10] your reaction seems genuine.")
