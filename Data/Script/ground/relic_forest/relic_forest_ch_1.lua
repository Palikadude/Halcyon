...
--[color=#00FFFF]Erleuchtet[color]
	...
	UI:WaitShowDialogue("(" .. GeneralFunctions.GetPronoun(hero, 'they', true) .. " even pinched " .. GeneralFunctions.GetPronoun(hero, 'themself') .. " like he was trying to wake up or something...)")
