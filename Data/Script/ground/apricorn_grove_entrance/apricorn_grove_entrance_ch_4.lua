...
function apricorn_grove_entrance_ch_4.FirstComeOutFront()
	...
	UI:WaitShowDialogue("Urk![pause=0] Seems like in this mystery dungeon,[pause=10] it's possible to go back the way you came.")
...
function apricorn_grove_entrance_ch_4.SubsequentAttemptCutscene()
	...
	GAME:WaitFrames(20)
	UI:SetSpeaker(partner)
	UI:WaitShowDialogue("OK![pause=0] We're back to the forest's entrance!")
