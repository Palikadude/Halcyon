...
function metano_altere_transition_ch_1.HeartToHeartCutscene()
	...
	UI:WaitShowDialogue("Living in Metano Town is so boring...[pause=0] Nothing exciting ever happens.")
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue("The adventurers in the guild however live such exciting lives![pause=0] I want to do what they do too!")
	...
	UI:WaitShowDialogue('Adventurers are the best![pause=0] They lead such exciting lives!')
	GAME:WaitFrames(20)
--	GROUND:CharAnimateTurnTo(partner, Direction.Up, 4)
	...
	UI:WaitShowDialogue("I don't have anyone who's willing to form a team with me...")
	UI:WaitShowDialogue("So I can't join the guild...[pause=0] I'm stuck with my quiet existence in Metano Town...")
	GAME:WaitFrames(20)
