...
function guild_second_floor_ch_3.Audino_Action(chara, activator)
	...
	UI:WaitShowDialogue("You can also use the boards to check which jobs you've taken already.")
	UI:WaitShowDialogue("Oh![pause=0] You s-should also know you need to activate a job before you can do it!")
	UI:WaitShowDialogue("To do that,[pause=10] look at the jobs you've taken and pick one.[pause=0] Then choose Take Job to activate that mission!")
	UI:WaitShowDialogue("Y-you can also suspend an activated job to save for later.[pause=0] Just choose Take Job on it again to reactivate it!")
	UI:WaitShowDialogue("A-anyways,[pause=10] once you've activated a job,[pause=10] just go to the mystery dungeon it's in to do it.")
