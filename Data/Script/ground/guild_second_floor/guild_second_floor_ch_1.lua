...
function guild_second_floor_ch_1.MeetNoctowl()
	...
	UI:WaitShowDialogue("Very well,[pause=10] I will take you to see the Guildmaster.[pause=0] Please follow behind me.")
...
function guild_second_floor_ch_1.Cranidos_Action(chara, activator)
	...
	if not SV.Chapter1.MetCranidosMareep then 
		...
		GAME:WaitFrames(10)
		GROUND:CharSetEmote(partner, 7, 1)
		...
		UI:SetSpeakerEmotion("Happy")
		GROUND:CharTurnToCharAnimated(mareep, partner, 4)
		UI:WaitShowDialogue("Oh,[pause=10] good![pause=0] I was afraid he was being a big mea-a-a-anie again!")
		UI:SetSpeakerEmotion("Normal")
