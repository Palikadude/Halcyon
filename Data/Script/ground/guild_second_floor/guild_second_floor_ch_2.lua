...
function guild_second_floor_ch_2.CameruptRequestCutscene()
	...
	UI:WaitShowDialogue("Furthermore,[pause=10] you will most of the money you are carrying and most items in your Treasure Bag.")
	...
	UI:WaitShowDialogue("I thought that would have been the end of it,[pause=10] but...[pause=0]\nI guess he ran off after I fell asleep.")
	UI:SetSpeakerEmotion("Teary-Eyed")
