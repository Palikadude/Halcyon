...
function guild_dining_room_ch_1.Snubbull_Action(chara, activator)
	...
	--	GAME:WaitFrames(20)
		...
		GeneralFunctions.HeroDialogue(hero, "(I don't have any idea how foods taste as a Pokémon...)", "Worried")
		GAME:WaitFrames(20)
		...
		UI:SetSpeakerEmotion("Sad")	
		UI:WaitShowDialogue("But it's rare for me to come across those sorts of delicacies in my own travels...")
		UI:WaitShowDialogue("...And the Guildmaster only stocks more basic provisions.")
