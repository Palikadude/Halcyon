...
function guild_dining_room_ch_1.Snubbull_Action(chara, activator)
	...
	if not SV.Chapter1.MetSnubbull then
		...
		UI:WaitShowDialogue("Now we're exploring different rooms to say hello to everyone.")
		GAME:WaitFrames(20)
		
		UI:SetSpeaker(STRINGS:Format("\\uE040"), true, snubbull.CurrentForm.Species, snubbull.CurrentForm.Form, snubbull.CurrentForm.Skin, snubbull.CurrentForm.Gender)
		UI:WaitShowDialogue("We[pause=10] alright.[pause=0] I didn't realize we had new recruits today.")
		...
		UI:WaitShowDialogue("(None of those sound any good...[pause=0] Is she really a chef?)")
		GAME:WaitFrames(20)
	...
	--	GAME:WaitFrames(20)
		...
		GeneralFunctions.HeroDialogue(hero, "(I don't really have any idea how foods taste as a Pokémon...", "Worried")
		GAME:WaitFrames(20)
		...
		UI:SetSpeakerEmotion("Sad")	
		UI:WaitShowDialogue("But the Guildmaster usually buys more basic provisions...[pause=0] So I typically only get to make more plebian meals...")
		GAME:WaitFrames(20)
