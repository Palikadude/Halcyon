...
function base_camp.Prepare(map)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
end
...
function base_camp.Update(map, time)
end
...
function base_camp.BeginExposition()  
  ...
  GROUND:MoveInDirection(noctowl, Direction.UpRight, 17)
  ...
  GROUND:MoveInDirection(noctowl, Direction.UpLeft, 17)
  ...
  GROUND:MoveInDirection(noctowl, Direction.DownLeft, 17)
  ...
  GROUND:MoveInDirection(noctowl, Direction.Left, 101)
  GROUND:EntTurn(noctowl, Direction.Right)
...
function base_camp.First_North_Exit_Touch(obj, activator)  
  ...
  local zone = RogueEssence.Data.DataManager.Instance:GetZone(19)
  UI:ChoiceMenuYesNo(STRINGS:FormatKey("DLG_ASK_ENTER_DUNGEON", zone.Name:ToLocal()), false)
  UI:WaitForChoice()
  ch = UI:ChoiceResult()
  if ch then
...
function base_camp.Sign_Action(obj, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  UI:ResetSpeaker()
  UI:WaitShowMonologue(STRINGS:Format(MapStrings['Sign_Action_Text']))
end
...
function base_camp.Noctowl_Action(chara, activator)
  ...
  result = 2
  while result == 2 do
    UI:BeginChoiceMenu(STRINGS:Format(MapStrings['Noctowl_Ask_Tutorial']), tutorial_choices, 1, 3)
    UI:WaitForChoice()
    ...
    elseif result == 3 then
      ...
      UI:WaitShowDialogue(STRINGS:Format(MapStrings['Noctowl_Tutorial_Line_001']))
