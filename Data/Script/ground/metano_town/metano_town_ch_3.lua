...
function metano_town_ch_3.MeetTeamStyle()	
	...
	coro2 = TASK:BranchCoroutine(function() UI:WaitShowDialogue("Tch![pause=0] You're doing a lot of talking for a newbie team![pause=0] What kind of adventures have you even gone on?")
