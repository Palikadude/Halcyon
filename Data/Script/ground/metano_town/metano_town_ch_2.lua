...
function metano_town_ch_2.Machamp_Luxray_Dialogue(chara)
	...
	local coro2 = TASK:BranchCoroutine(function() UI:WaitShowDialogue("Hoo...[pause=0] I tell ya,[pause=10] that's gotta be real rough fer " .. CharacterEssentials.GetCharacterName('Camerupt') .. ".") end)
    TASK:JoinCoroutines({coro1, coro2})
