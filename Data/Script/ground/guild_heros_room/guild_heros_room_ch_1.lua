...
function guild_heros_room_ch_1.Bedtalk()
	...
	UI:WaitShowDialogue(".........")
	UI:WaitShowDialogue("We'd better try to get some sleep...[pause=0] We don't want to be zombies in the morning.")
	...
	UI:WaitShowDialogue("(But...[pause=0] I can't help but feel so excited about this.)")
	...
	UI:WaitShowDialogue("(I've been turned into a Pokémon without memories and was lying unconscious near a strange tablet in a forest...)")
...
function guild_heros_room_ch_1.RoomIntro()
	...
	GAME:WaitFrames(20)
	GeneralFunctions.HeroDialogue(hero, "(Still...[pause=0] It is amazing how we managed to join up with the guild.)", "Normal")
	GeneralFunctions.HeroDialogue(hero, "(I'm pretty excited about it too![pause=0] I think I'm going to have a lot of fun adventuring with " .. partner:GetDisplayName() .. "!)", "Happy")
