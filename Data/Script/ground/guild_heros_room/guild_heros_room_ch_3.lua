...
function guild_heros_room_ch_3.PostOutlawBedtalk()
	...
	UI:WaitShowDialogue("...After yelling at me for trying to sneak into the forest,[pause=10] anyway...")
	UI:WaitShowDialogue("One time he told me about the legend of the Life Cores.[pause=0] That story was always my favorite!")
	
	GAME:WaitFrames(20)
	GeneralFunctions.HeroDialogue(hero, "(Huh?[pause=0] Life Cores?)", "Worried")
	
	GAME:WaitFrames(20)
	UI:SetSpeaker(partner:GetDisplayName(), true, "", -1, "", RogueEssence.Data.Gender.Unknown)
	SOUND:PlayBGM('Time Gear Remix.ogg', true)
	UI:SetSpeaker(partner)
	UI:WaitShowDialogue("He told me that Life Cores are these mystical,[pause=10] living fragments of something greater that exist in hidden places around the world.")
	...
	UI:WaitShowDialogue("According to " .. CharacterEssentials.GetCharacterName("Relicanth") .. ",[pause=10] Life Cores are responsible for allowing a region of the world to sustain life.")
	UI:WaitShowDialogue("If something was to destroy a region's Life Core...[pause=0] Well,[pause=10] " ..  CharacterEssentials.GetCharacterName("Relicanth") .. " didn't seem too sure what would happen.")
	...
	UI:WaitShowDialogue("If they are,[pause=10] we'll have to do everything we can to protect the Life Cores so nothing bad ever happens to them.")
