...
Thinks about when he feels strange besides the times he told the partner, they muse a bit on it, then resolve to look into it once the expedition is through
	...
	UI:WaitShowDialogue("Hey,[pause=10] " .. hero:GetDisplayName() .. ",[pause=10] do you remember right before we joined the guild,[pause=10] how I promised to help solve your amnesia?")
	...
	GeneralFunctions.HeroDialogue(hero, "(But with the expedition coming up,[pause=10] it makes sense to focus on that for now.)", "Normal")
	GAME:WaitFrames(20)
	GeneralFunctions.DoAnimation(hero, "Nod")
	GAME:WaitFrames(40)
