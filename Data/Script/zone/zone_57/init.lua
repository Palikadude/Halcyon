...
-- Map Callbacks
--------------------------------------------------
function zone_57.Init(zone)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  PrintInfo("=>> Init_zone_57")
...
function zone_57.Rescued(zone, mail)
  COMMON.Rescued(zone, mail)
end


function zone_57.ExitSegment(zone, result, rescue, segmentID, mapID)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  PrintInfo("=>> ExitSegment_zone_57 (Crooked Cavern) result "..tostring(result).." segment "..tostring(segmentID))
